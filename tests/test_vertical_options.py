...
from tests.filter_fixtures import default_filters
...
def test_long_call_spread(one_day_data, default_filters):
...
def test_short_call_spread(one_day_data, default_filters):
...
def test_long_put_spread(one_day_data, default_filters):
...
def test_short_put_spread(one_day_data, default_filters):
